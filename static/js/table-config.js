    $(document).ready(function() {
        $('#tablaDatos').DataTable({
            ...
            buttons: [
                {
                    ...
                    exportOptions: { columns: [0, 1, 2, 3, 4] } // No exporta la columna de "Acciones"
                },
                {
                    extend: 'pdfHtml5',
                    text: '📕 PDF',
            ...
            // 5. Idioma (mantenemos tu configuración offline)
            language: {
                "sProcessing":     "Procesando...",
                "sLengthMenu":     "Mostrar _MENU_ registros",
                "sZeroRecords":    "No se encontraron resultados",
                "sEmptyTable":     "Ningún usuario registrado en esta ficha todavía",
